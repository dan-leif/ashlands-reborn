...
internal static class CharredWarriorPatches
{
    ...
    // Per-bone position/orientation hybrid: Player position+scale, Charred orientation.
    private static readonly Dictionary<string, Matrix4x4> s_chestRetargetedBPs = new()
    {
            { "Hips", M4(0.17656492f, 0f, 0f, 2.5903262e-05f, 0f, 3.7638248e-08f, 0.18557833f, 0.0042964648f, 0f, -0.17656495f, 3.5810189e-08f, -0.00017281888f, 0f, 0f, 0f, 1f) },
            { "Spine", M4(0.17656492f, -4.1997975e-08f, 2.8763167e-09f, 2.5903264e-05f, 0f, 0.012675929f, 0.1850851f, 0.0030984813f, -4.2108617e-08f, -0.17620364f, 0.012067664f, 2.8748946e-05f, 0f, 0f, 0f, 1f) },
            { "Spine1", M4(0.17656489f, -4.1608299e-08f, 6.391597e-09f, 2.5903279e-05f, 0f, 0.028162496f, 0.1833334f, 7.80138e-05f, -4.2115786e-08f, -0.17459844f, 0.026820688f, 7.5672309e-05f, 0f, 0f, 0f, 1f) },
            { "Spine2", M4(0.1765649f, 0f, 0f, 2.590326e-05f, 0f, -0.0038635815f, 0.18544361f, -0.0014059822f, 0f, -0.17660806f, -0.0036794997f, 0.00024031851f, 0f, 0f, 0f, 1f) },
            { "Neck", M4(0.17566757f, -0.017838998f, -0.0020464242f, 9.7314718e-05f, 2.4112241e-09f, -0.020794721f, 0.1812709f, -0.0029375167f, -0.018239148f, -0.17727514f, -0.020336343f, 0.00070829492f, 0f, 0f, 0f, 1f) },
            { "Head", M4(-3.6023147e-07f, 0.17775531f, -9.5355205e-08f, 7.5772441e-05f, -3.294188e-08f, 5.4903293e-08f, 0.18422508f, -0.0036710463f, 0.17656493f, 3.1572296e-07f, -1.0524208e-08f, 6.8916706e-05f, 0f, 0f, 0f, 1f) },
            { "Jaw", M4(0.17656489f, 6.2880832e-07f, -1.2991691e-08f, 6.8919435e-05f, 5.1750652e-07f, -0.14739211f, -0.10066645f, 0.0015479149f, -3.7955618e-07f, 0.10344733f, -0.15146378f, 0.0038567984f, 0f, 0f, 0f, 1f) },
            { "LeftShoulder", M4(0.066375315f, 0.16362579f, 0.0049881283f, -0.00013332181f, -0.16441827f, 0.0667485f, -0.0016965835f, -0.00085533335f, -0.0035928101f, -0.0041634473f, 0.18438202f, -0.0028242443f, 0f, 0f, 0f, 1f) },
            ...
            { "RightShoulder", M4(0.066375315f, -0.16362576f, -0.0049881279f, 0.00015279751f, 0.16441824f, 0.066748485f, -0.0016965831f, -0.00080709503f, 0.0035928101f, -0.0041634473f, 0.18438202f, -0.0028231959f, 0f, 0f, 0f, 1f) },
            ...
            { "LeftUpLeg", M4(0.17656688f, 0f, 0f, 0.0010541104f, 0f, 0.00062904332f, -0.18553099f, -0.0031505434f, 0f, 0.17660075f, 0.00059876527f, 0.00013001851f, 0f, 0f, 0f, 1f) },
            { "LeftLeg", M4(0.17656416f, 0.00052702922f, -0.0004640157f, 0.0011078288f, -0.00055376621f, 0.023496432f, -0.18402819f, -0.0078433128f, -0.00046413462f, 0.17518799f, 0.022369128f, 0.0007497422f, 0f, 0f, 0f, 1f) },
            { "LeftFoot", M4(0.17656493f, 3.64963739e-08f, -7.65585071e-08f, 0.0011720527f, 3.01082145e-11f, -0.16211849f, -0.077214397f, -0.0047226516f, -8.75523867e-08f, 0.078375898f, -0.16455716f, -0.011386477f, 0f, 0f, 0f, 1f) },
            { "LeftToeBase", M4(0.17676817f, 5.6698337e-11f, -1.09289307e-10f, 0.0010485119f, 5.66044711e-11f, -0.17657915f, -5.3714044e-05f, -0.0011896937f, -1.14598074e-10f, 5.63746362e-05f, -0.18532558f, -0.013823148f, 0f, 0f, 0f, 1f) },
            { "RightUpLeg", M4(0.1765669f, 0f, 0f, -0.0010023032f, 0f, 0.00062904326f, -0.18553096f, -0.0031505427f, 0f, 0.17660074f, 0.00059876527f, 0.00013001922f, 0f, 0f, 0f, 1f) },
            { "RightLeg", M4(0.17656416f, -0.00052702922f, 0.0004640157f, -0.0010560232f, 0.00055376621f, 0.023496432f, -0.18402819f, -0.0078431526f, 0.00046413462f, 0.17518799f, 0.022369128f, 0.00074987841f, 0f, 0f, 0f, 1f) },
            { "RightFoot", M4(0.17656493f, -3.64107535e-08f, 7.65859625e-08f, -0.0011202462f, 6.05081263e-11f, -0.16211849f, -0.077214397f, -0.0047226525f, 8.75399593e-08f, 0.078375898f, -0.16455716f, -0.011386477f, 0f, 0f, 0f, 1f) },
            { "RightToeBase", M4(0.17676817f, 2.67662524e-11f, 1.34700737e-10f, -0.00099664542f, 2.67785603e-11f, -0.17657918f, -5.3724576e-05f, -0.0011896936f, 1.41213069e-10f, 5.63856956e-05f, -0.18532561f, -0.013823152f, 0f, 0f, 0f, 1f) },
    };
        ...
        VisEquipment vis, FieldInfo? instanceField, string armorItemName, float userScale)
    {
        ...
        foreach (var armorGo in instances)
        {
            ...
            foreach (var smr in smrs)
            {
                ...
                if (isChest)
                {
                    // Hybrid: v7 formula for torso (proven perfect), Blender retargeted for limbs.
                    for (int i = 0; i < prefabBoneNames.Length && i < originalBPs.Length; i++)
                    {
                        var boneName = prefabBoneNames[i];
                        bool isTorso = boneName == "Hips" || boneName == "Spine" ||
                                       boneName == "Spine1" || boneName == "Spine2" ||
                                       boneName == "Neck" || boneName == "Head" || boneName == "Jaw";
                        if (isTorso)
                        {
                            // v7: charredBPMap * scaleMat — correct for torso bones
                            Matrix4x4 cBP;
                        ...
                        {
                            // Blender per-bone hybrid for arms/hands/legs
